...
const UECodeGen_Private::FEnumPropertyParams Z_Construct_UScriptStruct_FQTEInputStep_Statics::NewProp_InputType = { "InputType", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FQTEInputStep, InputType), Z_Construct_UEnum_BCR_EQTEInputType, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_InputType_MetaData), NewProp_InputType_MetaData) }; // 2520456560
...
const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FQTESequence_Statics::NewProp_PlayerSubSequences_ValueProp = { "PlayerSubSequences", nullptr, (EPropertyFlags)0x0000000000000001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 1, Z_Construct_UScriptStruct_FPlayerSubSequence, METADATA_PARAMS(0, nullptr) }; // 2452709747
...
struct Z_CompiledInDeferFile_FID_Users_seryl_Desktop_Fichiers_Ynov_cours_M2_ProjetM2_M2_Project_Source_BCR_Headers_System_QTE_QTETypes_h_Statics
{
	static constexpr FEnumRegisterCompiledInInfo EnumInfo[] = {
		{ EQTEInputType_StaticEnum, TEXT("EQTEInputType"), &Z_Registration_Info_UEnum_EQTEInputType, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 2520456560U) },
	};
	static constexpr FStructRegisterCompiledInInfo ScriptStructInfo[] = {
		{ FQTEInputStep::StaticStruct, Z_Construct_UScriptStruct_FQTEInputStep_Statics::NewStructOps, TEXT("QTEInputStep"), &Z_Registration_Info_UScriptStruct_QTEInputStep, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FQTEInputStep), 2660677135U) },
		{ FPlayerSubSequence::StaticStruct, Z_Construct_UScriptStruct_FPlayerSubSequence_Statics::NewStructOps, TEXT("PlayerSubSequence"), &Z_Registration_Info_UScriptStruct_PlayerSubSequence, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FPlayerSubSequence), 2452709747U) },
		{ FQTESequence::StaticStruct, Z_Construct_UScriptStruct_FQTESequence_Statics::NewStructOps, TEXT("QTESequence"), &Z_Registration_Info_UScriptStruct_QTESequence, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FQTESequence), 156844503U) },
		{ FQTEConfiguration::StaticStruct, Z_Construct_UScriptStruct_FQTEConfiguration_Statics::NewStructOps, TEXT("QTEConfiguration"), &Z_Registration_Info_UScriptStruct_QTEConfiguration, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FQTEConfiguration), 3397164208U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_seryl_Desktop_Fichiers_Ynov_cours_M2_ProjetM2_M2_Project_Source_BCR_Headers_System_QTE_QTETypes_h_4073075405(TEXT("/Script/BCR"),
	nullptr, 0,
